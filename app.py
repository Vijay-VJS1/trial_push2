...
##################
df=pd.read_feather("movie_deploy_medium.feather")
movies_list=df['title'].values
movies_list=np.append(movies_list,"")
movies_list=sorted(movies_list)
similarity1=pd.read_feather('similarity1_medium.feather')
similarity2=pd.read_feather('similarity2_medium.feather')
######################
rows=5
columns=5
num_movies=25
...
# if st.sidebar.checkbox("small"):
#   size='small'
# elif st.sidebar.checkbox("medium"):
#   size='medium'
